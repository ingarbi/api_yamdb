# Generated by Django 3.2 on 2023-04-26 07:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(blank=True, null=True, verbose_name='Кратко о себе')),
                ('role', models.CharField(choices=[('Пользователь', 'user'), ('Модератор', 'moderator'), ('Администратор', 'admin')], default='Пользователь', max_length=13, verbose_name='Роль')),
